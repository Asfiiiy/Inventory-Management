    ...
    <div class="row">
      ...
      <div class="form-group ">
        ...
        <input type="hidden" class="form-control" id="product_idd<?php echo $count ?>" name="product_id[]"  readonly>  -->
                ...
                <!-- ****************************************************** -->
                <select class="form-control select2" id="product_id1<?php echo $count ?>" name="product_id[]" required>
        ...
        <div class="col-md-2">
            <div class="form-group ">
                ...
                <input type="number" step="any" name="purchase_price[]" id="purchase_price_Id<?php echo $count ?>"
                    onkeyup="Purchase_Price(<?php echo $count ?>)" class="form-control" placeholder="Purchase Price"
                    required>
            </div>
        </div>
        <!--  <div class="col-md-2">
        ...
        <div class="col-md-2">
            <div class="form-group ">
                ...
                <input type="number" step="any" name="quantity[]" class="form-control" placeholder="Quantity" value="1"
                    onchange="Purchase_Price(<?php echo $count ?>)" id="quantity<?php echo $count ?>" required>
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Cans</label>
                <input type="number" step="any" name="cans[]" class="form-control" placeholder="Num of Cans"
        ...
        <div class="col-md-2">
            <div class="form-group ">
                ...
                <input type="number" step="any" name="purchase_total[]" class="form-control"
                    placeholder="Purchase Total" readonly id="Purchase_Total_Id<?php echo $count ?>">
            </div>
        </div>
        <div class="col-md-1">
            <br>
