...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="mt-3 text-dark">Acid Details</h4>
      </div>
    </div>
  </div>
</div>
              ...
              <tbody class="table-font-size">
                ...
                ?>
                  <tr class="my-table-row-hover">
                    ...
                    <td>
                    <a href="acid_update.php?id=<?php echo $id ?>" class="mt-1 Data_Ajax title btn btn-success btn-sm" title="Edit"><i class="bx bx-edit"></i></a>
...
?>
                   <script type="text/javascript">
                      function deleteData(id) {
                        Swal.fire({
                          ...
                          if (result.isConfirmed) {
                            window.location.href = "acids_details.php?deleteId=" + id;
                          }
                        });
                      }
                    </script>
                    ...
                    if (isset($_GET['deleteId'])) {
                      $id = $_GET['deleteId'];
                      $query = "DELETE FROM acid WHERE id = '$id'";
