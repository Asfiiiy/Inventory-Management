<?php include("include/header.php") ?>
    ...
    $query11 = "INSERT INTO `acid` (`customer_name`, `purchase_date`, `product_name`, `price`, `description`) 
...
// $update_run = mysqli_query($connection, $update_query1);
      ...
      <html>
        <body>
          ...
          Swal.fire(
          'Added!',
          'Acid has been successfully added!',
          'success'
          ).then((result) => {
          if (result.isConfirmed) {
          window.location.href = 'acids.php';
          }
          });
          </script>
        </body>
