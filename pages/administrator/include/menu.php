...
<div class="sidebar-wrapper printBlock" data-simplebar="true">
    ...
    <li>
            ...
            <ul>
                <li><a href="view_accounts.php"><i class="bx bx-right-arrow-alt"></i>View Accounts</a>
                </li>
                <li class="z"><a href="accounts_ledger.php"><i class="bx bx-right-arrow-alt"></i>Account Ledger</a>
                </li>
        ...
        <li class="z">
            ...
            <ul>
                ...
                <li> <a href="supplier_payment_list.php"><i class="bx bx-right-arrow-alt"></i>Payment List</a>
                </li>
                <li> <a href="supplier_payment_details.php"><i class="bx bx-right-arrow-alt"></i>Payment Details</a>
                </li>
                <li> <a href="supplier_ledger.php"><i class="bx bx-right-arrow-alt"></i>Supplier Ledger</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="customer_payment.php"><i class="bx bx-right-arrow-alt"></i>Customer Payment</a>
                </li>
                <li> <a href="customer_payment_list.php"><i class="bx bx-right-arrow-alt"></i>Payment List</a>
                </li>
                <li> <a href="customer_payment_details.php"><i class="bx bx-right-arrow-alt"></i>Payment Details</a>
                </li>
                <li> <a href="customer_ledger.php"><i class="bx bx-right-arrow-alt"></i>Customer Ledger</a>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                <li><a href="purchase_pro_and_date_wise_report.php"><i class="bx bx-right-arrow-alt"></i>Purchase
                        Report</a></li>
                <li><a href="sale_product_wise_report.php"><i class="bx bx-right-arrow-alt"></i>Sale Report</a></li>
                ...
                <li><a href="stock_product_wise_report.php"><i class="bx bx-right-arrow-alt"></i>Stock Product
                        Report</a></li>
                <li><a href="report_expenses.php"><i class="bx bx-right-arrow-alt"></i>Expences Report</a></li>
                <li><a href="account_wise_transcation.php"><i class="bx bx-right-arrow-alt"></i>Account-wise Transaction
                        Summary</a></li>
   ...
   <li>
    ...
    <li><a href="profit_loss_report.php"><div class="parent-icon"><i class="bx bx-arrow-to-top"></i></div>Profit & Loss</a></li>
    <li>
          <a href="javascript:;" class="has-arrow">
        ...
        <li class="z">
            ...
            <ul>
                <li> <a href="total_purchase.php"><i class="bx bx-right-arrow-alt"></i>Purchase List</a>
                </li>

                <li> <a href="purchase_return_list.php"><i class="bx bx-right-arrow-alt"></i>Return Product List</a>
                </li>
            </ul>
        </li>
        ...
        <li class="z">
            ...
            <ul>
                ...
                <li><a href="payment_type.php"><i class="bx bx-right-arrow-alt"></i>Add Payment Type</a></li>
