...
// }
    $insert = "UPDATE `charge` SET `customer_name`='$customer_name',`purchase_date`='$purchase_date',`product_name`='$product_name',`price`='$price',`description`='$Description' WHERE id = '$charge_id'";
      ...
      echo " <!DOCTYPE html>
                      <html>
                        <body>
                          ...
                          Swal.fire(
                          'Updated!',
                          'Charge has been successfully Updated!',
                          'success'
                          ).then((result) => {
